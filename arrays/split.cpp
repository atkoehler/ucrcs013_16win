...
void splitAdam(char[], char[], char[], char);
void splitJason(char[], char[], char[], char);

int main() {
    char str[80]="The Force Awakens";
    char part1[80] = {0};
    char part2[80] = {0};
...
void splitAdam(char str[], char a[], char b[], char delim) 
{
...
void splitJason(char str[], char a[], char b[], char delim) 
{
